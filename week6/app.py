...
class CourseAPI(Resource):
    ...
    @marshal_with(course_fields)
    def put(self, course_id): # Update database, PUT values into Course
        course = Course.query.filter(Course.course_id == course_id).first()
        ...
        # Check for Errors with the given inputs given by user
        ...
        # Else do the update onto the database
...
class StudentAPI(Resource):
    ...
    @marshal_with(student_fields)
    def put(self, student_id): # Update database, PUT values into Student      
        student = Student.query.filter(Student.student_id == student_id).first()
